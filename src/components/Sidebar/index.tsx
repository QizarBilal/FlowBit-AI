  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-[2000] lg:hidden bg-blue-600 text-white p-3 rounded-lg shadow-lg hover:bg-blue-700 transition-colors"
      ...
      {/* Sidebar */}
      <div className={`fixed lg:relative top-0 left-0 h-screen w-80 max-w-[85vw] bg-white border-r border-gray-300 flex flex-col z-[1500] transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
      {/* Header */}
      ...
      {isOpen && (
        <div 
          className="fixed inset-0 bg-black bg-opacity-50 z-[1400] lg:hidden"
